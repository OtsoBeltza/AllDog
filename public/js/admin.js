              ...
              ${chiens.map(chien => `
                <tr data-id="${chien.id}" class="${chien.statut === 'Évalué' ? 'bg-green-50' : ''}">
                  ...
                  <td class="px-6 py-4 whitespace-nowrap">
                    <span class="px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${chien.statut === 'Disponible' ? 'bg-blue-100 text-blue-800' : chien.statut === 'En évaluation' ? 'bg-yellow-100 text-yellow-800' : 'bg-green-100 text-green-800'}">
                      ${chien.statut}
                    </span>
                  </td>
